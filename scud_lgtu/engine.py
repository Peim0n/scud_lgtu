...
from .data_types import ScudEvent, ScudCommand, EventType, EventSource, CommandTarget, CommandAction
from .config import load as load_config
from .OPZeroLTS_Controller import GpiodPinController, PinControllerThread
from .wiegand_reader import WeigandReader, CardData
from .serial_handler import BackgroundSerialReader
...
class ScudEngine:
    ...
    def run_lgtu_controller(self) -> None:
        ...
        from .data_types import EventStore
        import os
