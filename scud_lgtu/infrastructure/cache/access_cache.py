...
Этот модуль реализует локальный кэш для хранения списков доступа, полученных от бэкенда,
для работы офлайн. Поддерживает загрузку из JSON-файла для тестирования и хеширование
идентификаторов с использованием статического и динамического ключей.
...
------------------------
- __init__: загрузить кэш из JSON, если указан путь
...
- load_json: загрузить кэш из JSON-файла
- save_json: сохранить кэш в JSON-файл
"""
...
from scud_lgtu.infrastructure.cache.identifier_hash import hash_identifier, normalize
