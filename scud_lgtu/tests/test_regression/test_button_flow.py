"""Regression test for button flow."""
import pytest
...
def test_button_event_processing(controller):
    """Test that button event is processed without errors."""
    # Arrange
    ...
    # (Specific behavior depends on button configuration, just ensure no crash)
